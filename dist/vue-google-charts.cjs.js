...
function loadGoogleCharts() {
    let version = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 'current', settings = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {
    };
...
var script = {
    ...
    methods: {
        ...
        attachListeners () {
            ...
            Object.entries(this.events).forEach((param)=>{
...
const plugin = {
    /* eslint-disable no-undef */ version: VERSION,
    install
};
// Auto-install
let GlobalVue = null;
...
exports.GChart = script;
exports["default"] = plugin;
exports.install = install;
exports.loadGoogleCharts = loadGoogleCharts;
//# sourceMappingURL=vue-google-charts.cjs.js.map
